const BASE=new URL('./',self.location.href),PREFIX='ajolista-local-'+BASE.pathname+'-',CACHE=PREFIX+"abdf264776190fd9",URLS=["assets/index-CNRsrNap.js","assets/index-Cux6jbdz.css","icon-192.png","icon-512.png","index.html","manifest.webmanifest"].map(p=>new URL(p,BASE).href);
