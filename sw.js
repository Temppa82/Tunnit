const BASE=new URL('./',self.location.href),PREFIX='ajolista-local-'+BASE.pathname+'-',CACHE=PREFIX+"058eb0db0257151a",URLS=["icon-192.png","icon-512.png","index-BBVtZk1X.css","index-DoR1iqo8.js","index.html","manifest.webmanifest"].map(p=>new URL(p,BASE).href);
