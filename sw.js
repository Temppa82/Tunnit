const BASE=new URL('./',self.location.href),PREFIX='ajolista-local-'+BASE.pathname+'-',CACHE=PREFIX+"2c85038e4242604c",URLS=["icon-192.png","icon-512.png","index-BBVtZk1X.css","index-Cnkdp7m6.js","index.html","manifest.webmanifest"].map(p=>new URL(p,BASE).href);
